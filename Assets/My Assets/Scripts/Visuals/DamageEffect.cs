...
public class DamageEffect : MonoBehaviour {
    ...
    public static void CreateDamageEffect(Vector3 position, int amount)
    {
        ...
        GameObject newDamageEffect = new GameObject(); // FIX THIS LATER = GameObject.Instantiate(GlobalSettings.Instance.DamageEffectPrefab, position, Quaternion.identity) as GameObject;
